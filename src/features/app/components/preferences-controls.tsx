...
function screenLabel(code:string,fallback:string,locale:Locale){const labels:Record<string,[string,string]>={dashboard:["Resumen","Dashboard"],members:["Miembros","Members"],memberships:["Membresías","Memberships"],payments:["Pagos","Payments"],income:["Ingresos","Income"],entries:["Entradas","Entries"],facial_access:["Entradas","Entries"],staff:["Personal","Staff"],settings:["Configuración","Settings"]};return labels[code]?.[locale==="es"?0:1]??fallback;}
